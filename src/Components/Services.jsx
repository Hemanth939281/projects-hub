...
const Services = () => {
  ...
  const [ideasPerPage, setideasPerPage] = useState(3);
  const lastIdeaIndex = currentPage * ideasPerPage;
  const firstIdeaIndex = lastIdeaIndex - ideasPerPage;
  const currentPageIdeas = ideas.slice(firstIdeaIndex, lastIdeaIndex);
